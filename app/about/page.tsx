...
const content = {
  en: {
    ...
    sections: [
      ...
      { h: "Exclusive by design", p: "Admission requires an invitation code. This is not gatekeeping for its own sake — it is the mechanism that keeps the community meaningful. When everyone has a chief.me page, no one does. We are building for the 1,000 leaders who shape the next decade, not the 100 million who want to look like them." },
      ...
      { h: "Contact", p: "For partnerships, press, or invitations: hello@chief.me" },
    ],
  },
  zh: {
    title: "关于 Chief.me",
    sections: [
      ...
      { h: "设计上的专属性", p: "加入需要邀请码。这不是为了设门槛而设门槛——它是保持社区有意义的机制。当所有人都有 chief.me 页面时，就没有人真正拥有它了。我们为塑造下一个十年的 1,000 位领导者而建，而不是为想要看起来像他们的 1 亿人。" },
      { h: "永久免费", p: "Chief.me 现在是、将来也会是对所有成员免费。我们的信念：适合高管的平台，不应该是对信誉收取订阅税。我们将通过为有需要的用户提供增值服务来建立可持续的商业模式——绝不以核心体验收费。" },
      { h: "联系我们", p: "合作、媒体或邀请码申请：hello@chief.me" },
    ],
  },
};
