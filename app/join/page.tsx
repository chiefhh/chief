  ...
  return (
    <div className="relative w-full max-w-md">
      ...
      <div className="rounded-[20px] p-8" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(184,148,79,0.15)" }}>
        ...
        {/* Global error (from NextAuth redirect) */}
        {error && !verified && (
        ...
        {!verified ? (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-[#B8944F] hover:bg-[#9d7c3e] text-[#FEFCF7] font-body font-medium rounded-full py-3 text-sm transition-colors cursor-pointer"
            >
              {t.next}
            </button>
          </div>
